...
describe PisPasep::Base do
  ...
  it 'formats the number at instantiation' do
    PisPasep::Base.new('12345678919').numero.should == '123.45678.91-9'
  end
